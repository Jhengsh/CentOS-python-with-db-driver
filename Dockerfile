...
RUN miniforge_arch=$(uname -m) && \
    ...
    ${CONDA_DIR}/bin/mamba install --quiet --yes python=3.10.6 && \
...
RUN rpm -ivh https://download.oracle.com/otn_software/linux/instantclient/218000/oracle-instantclient-basic-21.8.0.0.0-1.x86_64.rpm && \
